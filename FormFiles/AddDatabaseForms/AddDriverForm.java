...
/**
 * This class is used to add a driver to the database based on the user's input of the features the database takes into
        ...
        EventHandler<MouseEvent> ok_event = e -> {
            ...
            try {
                ...
                if(!nameLabel.getText().isEmpty()) {
                    ...
                    getDba().set_driver(nameField.getText());
                }
                else {
