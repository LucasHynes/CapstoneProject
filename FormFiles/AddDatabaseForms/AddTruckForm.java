...
public class AddTruckForm {
    ...
    public Scene form() throws SQLException {
        ...
        TextField truckNameField = new TextField();
        ...
        EventHandler<MouseEvent> okEvent = e -> {
            ...
            if(!truckNameField.getText().isEmpty()) {
                ...
                try {
                    ...
                    getDba().set_truck(truckNameField.getText(), driver_associated.getValue());
                ...
                try {
                    ...
                    //set using database object
                    getDba().set_truck("Unspecified", driver_associated.getValue());
