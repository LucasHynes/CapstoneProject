...
/**
 * This class is used to facilitate the ability of the user to add a store or distributor to the database so be able to
 * use in the process of scheduling
 *
 * @author Lucas Hynes
 * @version 1.0
 * @since 2/24/2021
...
public class AddDestinationForm {
    ...
    public Scene form() {
        ...
        TextField lat_field = new TextField();
        TextField long_field = new TextField();
        ...
        EventHandler<MouseEvent> ok_event = e -> {
            ...
            if (sf_di_group.getSelectedToggle() == diButton) {
                ...
                try {
                    ...
                    getDba().set_distributor(new Distributor(
                            0, name, address, city, state, longitude, latitude));
                }
                ...
                try {
                    ...
                    getDba().set_storeFront(new StoreFront(
                            0, name, address, city, state, longitude, latitude));
                } catch (SQLException throwables) {
